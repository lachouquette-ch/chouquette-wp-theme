...
<div class="info-window">
    ...
    <button class="btn btn-sm btn-primary d-md-none" onclick="fichesMap.app.highlightFiche(<?php echo get_the_ID(); ?>)"><i class="fas fa-info mr-1"></i> Voir la fiche</button>
