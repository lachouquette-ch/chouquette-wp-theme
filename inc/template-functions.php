...
/**
 * ChouquetteMenuItem represents a menu item
 */
...
if (!function_exists('chouquette_acf_generate_post_id')) :
    ...
    function chouquette_acf_generate_post_id($item)
    {
        ...
        } elseif ($item instanceof ChouquetteMenuItem) {
    ...
    function chouquette_menu_items()
    {
        ...
        if (isset (get_nav_menu_locations()[CHOUQUETTE_PRIMARY_MENU])) {
            ...
            foreach ($menu_items as $menu_item) :
                ...
                // get logo
                $result_item->logo_class = get_field(CHOUQUETTE_MENU_LOGO_SELECTOR, chouquette_acf_generate_post_id($result_item));
