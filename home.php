        ...
        <div class="flex-grow-1">
            <div class="d-flex flex-column h-100 justify-content-center align-items-center">
                ...
                <div class="d-none d-md-flex flex-row flex-wrap justify-content-center text-center">
                    <div class="home-header-category m-3">
                ...
                <form class="home-header-filters row w-75">
                    <div class="col-lg-3 home-header-filters-item">
...
<footer class="home-footer container-fluid text-center">
    <div class="home-footer-top row py-3">
        <div class="col">
            <img style="height: 15rem" class="mx-auto" src="//projet-chouquette.site/wp-content/uploads/2017/06/Logo-Lausanne-More.jpg">
            <div class="home-footer-sn my-3"><i class="fab fa-pinterest-square mr-2"></i><i class="fab fa-facebook mx-2"></i><i class="fab fa-instagram mx-2"></i><i class="fas fa-rss-square ml-2"></i></div>
            <p class="mypacka-2"><span class="px-2">L'équipe</span><span class="px-2">Charte éditorial</span><span class="px-2">Contact</span></div>
    </div>
    </div>
    <div class="home-footer-bottom row py-3">
        <div class="col">
