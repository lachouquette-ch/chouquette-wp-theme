 ...
 */
function chouquette_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'chouquette' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'chouquette' ),
...
add_action( 'widgets_init', 'chouquette_widgets_init' );
...
function chouquette_scripts() {
	...
	wp_enqueue_script( 'chouquette-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'chouquette-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
