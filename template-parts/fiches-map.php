...
$faq_url = get_permalink(get_page_by_title('Foire aux Questions'));
        ...
        <div class="row">
            <div class="col-md-6 p-0 category-result-col">
                        ...
                        <div class="form-group col-md-4">
                            <select class="form-control" title="Sous catégorie" name="cat"
                                ...
                                foreach ($search_categories as $search_category) {
                                    $attr_selected = isset($default_category) && $default_category == $search_category->slug ? 'selected' : '';
                ...
                if ($loop->have_posts()):
                    ...
                    echo "Lieux Chouquettisés <a title=\"C'est quoi ces logos jaunes et blancs ?\" href='$faq_url'>?</a>";
                    echo '</div>';
